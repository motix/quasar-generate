...
export function monorepoSupportEslintConfig(eslintConfigJsFilePath: string) {
...
export function convertEslintConfigToTsOnly(eslintConfigJsFilePath: string, ignores?: string) {
  let eslintConfigJs = fs.readFileSync(eslintConfigJsFilePath, 'utf-8');

...
export default function patchQuasarAppVite(projectFolder: string, packageJsonFilePath: string) {
  ...
  fs.writeFileSync(
    `${projectFolder}/.yarn/patches/@quasar-app-vite-npm-2.5.4-007016bf60.patch`,

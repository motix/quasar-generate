...
export default function patchTrivagoPrettierPluginSortImports(
  ...
  fs.writeFileSync(
    `${projectFolder}/.yarn/patches/@trivago-prettier-plugin-sort-imports-npm-6.0.2-88f9e213cd.patch`,

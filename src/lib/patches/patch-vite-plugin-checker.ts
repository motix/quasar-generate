...
export default function patchVitePluginChecker(projectFolder: string, packageJsonFilePath: string) {
  ...
  fs.writeFileSync(
    `${projectFolder}/.yarn/patches/vite-plugin-checker-npm-0.12.0-20cc09e28e.patch`,

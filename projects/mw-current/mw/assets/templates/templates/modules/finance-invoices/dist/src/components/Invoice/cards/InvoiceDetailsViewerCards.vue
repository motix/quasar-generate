  ...
  <div class="q-gutter-y-md">
    ...
    >
      ...
      <q-card-section>
        ...
        <div v-if="m.contractSubtotal" class="row justify-between">
        ...
        <div v-if="m.relocatedSubtotal" class="row justify-between">
        ...
        <div v-if="m.relocatedVat" class="row justify-between">
        ...
        <div class="row justify-between">
          ...
          <div class="text-warning">
            <strong>
              {{ f.currency(mc.invoiceBalance(m)) }}
            </strong>
          </div>
        </div>
      </q-card-section>

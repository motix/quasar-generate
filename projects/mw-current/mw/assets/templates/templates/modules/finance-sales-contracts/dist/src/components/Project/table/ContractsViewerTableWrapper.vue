...
import useProjectViewPage_SalesContracts from 'composables/finance/project/useProjectViewPage_SalesContracts.js';
...
const {
  ...
  contractsReady,
  f,
} = useProjectViewPage_SalesContracts(props.scopeName);
</script>

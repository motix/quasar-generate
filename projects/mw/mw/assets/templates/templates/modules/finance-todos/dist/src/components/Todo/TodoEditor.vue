...
import type { MemberLite, Todo, TodoVm } from 'models/finance/index.js';
...
import useMemberOptions from 'composables/finance/shared/useMemberOptions.js';
...
const validationSchema = markRaw(
  object({
    name: stringRequired('Name').test({
      ...
      test: async (value) =>
        !value ||
        ((await validateUniqueField('finance_todos', 'name', value, vm.value.id)) &&

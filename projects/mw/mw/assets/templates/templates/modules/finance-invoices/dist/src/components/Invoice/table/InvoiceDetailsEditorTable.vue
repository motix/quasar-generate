...
import InvoiceAdditionEditorRows from './InvoiceAdditionEditorRows.vue';
import InvoiceDetailEditorRow from './InvoiceDetailEditorRow.vue';
...
function elConvert(el: Element | ComponentPublicInstance | null) {
  return el as ReturnType<
    typeof useTemplateRef<InstanceType<typeof InvoiceDetailEditorRow>>
        ...
        <q-markup-table id="detailsEditorTable" bordered separator="cell" wrap-cells>
          <thead>
            <tr>
              ...
              <th>Unit Price</th>
              <th>Amount</th>
              <th v-if="!$p.hasParent($p)" class="q-table--col-auto-width"></th>
            </tr>
          </thead>
          <tbody>
            <!-- Details -->
            <InvoiceDetailEditorRow
            ...
            <tr>
              ...
              <td>
                <TextField dense field-class="text-right">
                  <strong>{{ vmc.invoiceTotalQuantity(vm) }}</strong>
                </TextField>
              </td>
            ...
            <InvoiceAdditionEditorRows :scope-name="scopeName" />
            ...
            <tr>
              ...
              <!-- Amount -->
              <td class="text-right">
                <strong>{{ f.currency(vmc.invoiceTotal(vm)) }}</strong>
              </td>

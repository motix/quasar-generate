...
import type { Customer } from 'models/finance/index.js';

import { customersStoreDefaultSort, useCustomersStore } from 'stores/finance/Customers.js';
...
const SCOPE_NAME = 'customers-list-page';

...
import { membersStoreDefaultSort, useMembersStore } from 'stores/membership/Members.js';
...
$p.newUrl.value = '/team/new-member';
</script>
...
<template>
  <QPagePadding padding>
    <ListPage :composition="$p" :scope-name="SCOPE_NAME" @load-next-page="onLoadNextPage">
      ...
      <template #body-cell-userAccount="{ props }">
        <q-td :props="props">
          <UserAccount :uid="props.value" @loaded="updateMainTableStickyHeaders" />
        </q-td>
      </template>

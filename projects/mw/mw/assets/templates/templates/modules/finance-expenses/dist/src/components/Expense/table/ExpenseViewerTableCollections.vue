...
import ExpenseGroupExpensesTableWrapperProjectExpenseGroup from 'components/ExpenseGroup/table/ExpenseGroupExpensesTableWrapper_ProjectExpenseGroup.vue';
// •- /finance-project-expense-groups<% } else { %>•+ finance-project-expense-groups absent
import ExpenseGroupExpensesTableWrapper from 'components/ExpenseGroup/table/ExpenseGroupExpensesTableWrapper.vue';
...
<template>
  ...
  <!-- <% if (config.hasModule('finance-project-expense-groups')) { %>•+ finance-project-expense-groups -->
  <ExpenseGroupExpensesTableWrapperProjectExpenseGroup
    v-if="m.group"
    ref="groupExpenses"

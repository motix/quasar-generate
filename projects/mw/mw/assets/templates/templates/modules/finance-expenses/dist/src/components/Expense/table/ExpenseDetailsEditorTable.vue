...
import ExpenseAdditionEditorRows from './ExpenseAdditionEditorRows.vue';
import ExpenseDetailEditorRow from './ExpenseDetailEditorRow.vue';
...
function elConvert(el: Element | ComponentPublicInstance | null) {
  return el as ReturnType<
    typeof useTemplateRef<InstanceType<typeof ExpenseDetailEditorRow>>
      ...
      <q-card>
        ...
        <q-markup-table id="detailsEditorTable" bordered separator="cell" wrap-cells>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <TextField dense field-class="text-right">
                  <strong>{{ vmc.expenseTotalQuantity(vm) }}</strong>
                </TextField>
              </td>
            ...
            <ExpenseAdditionEditorRows :scope-name="scopeName" />
            ...
            <tr>
              ...
              <!-- Amount -->
              <td class="text-right">
                <strong>{{ f.currency(vmc.expenseTotal(vm)) }}</strong>
              </td>

...
export default function patchTrivagoPrettierPluginSortImports(projectFolder, packageJsonFilePath) {
    ...
    fs.writeFileSync(`${projectFolder}/.yarn/patches/@trivago-prettier-plugin-sort-imports-npm-6.0.2-88f9e213cd.patch`, `diff --git a/lib/src/preprocessors/vue-preprocessor.js b/lib/src/preprocessors/vue-preprocessor.js

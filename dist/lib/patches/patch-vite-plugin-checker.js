...
export default function patchVitePluginChecker(options) {
    if (options.rootWorkspaceFolder != undefined) {
        ...
        fs.writeFileSync(`${options.rootWorkspaceFolder}/.yarn/patches/vite-plugin-checker-npm-0.12.0-0000000000.patch`, `diff --git a/dist/checkers/eslint/main.js b/dist/checkers/eslint/main.js

export default async function getExtensionInfo(extensionPackageJsonFilePath) {
    ...
    extensionId = extensionId.substring(extensionId.lastIndexOf('/') + '/quasar-app-extension-'.length);
    return {

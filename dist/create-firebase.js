...
async function createFirebasePackage() {
    ...
    console.log(' \x1b[32mquasar-generate •\x1b[0m', `Creating Firebase package for \x1b[47m${config.packageName}\x1b[0m...`);
...
function firebasePackageLintingAndFormatting() {
    ...
    fs.copyFileSync(`${globalAssets}/Firebase Template/eslint.config.mjs`, `${firebaseRoot}/eslint.config.mjs`);
    fs.copyFileSync(`${globalAssets}/Firebase Template/.prettierrc.json`, `${firebaseRoot}/.prettierrc.json`);
    fs.copyFileSync(`${globalAssets}/Firebase Template/.prettierignore`, `${firebaseRoot}/.prettierignore`);
    fs.mkdirSync(`${firebaseRoot}/.vscode`);
    fs.copyFileSync(`${globalAssets}/Firebase Template/.vscode/settings.json`, `${firebaseRoot}/.vscode/settings.json`);
...
function finishFunctionsPackage(codebase) {
